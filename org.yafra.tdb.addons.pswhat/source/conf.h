/* RCS compile-time configuration */
	...
	/* $Id: conf.h,v 1.2 2004-02-05 18:25:36 mwn Exp $ */
...
#if defined(ps_mingw) || defined(ps_winnt)
...
#define CO "/usr/remote/bin/co" /* name of 'co' program */
#define COMPAT2 0 /* Are version 2 files supported?  */
#define DIFF "/usr/remote/bin/diff" /* name of 'diff' program */
#define DIFF3 "/usr/remote/bin/diff3" /* name of 'diff3' program */
...
#define ED "/usr/bin/ed" /* name of 'ed' program (used only if !DIFF3_BIN) */
#define MERGE "/usr/remote/bin/merge" /* name of 'merge' program */
...
#define SENDMAIL "/usr/lib/sendmail" /* how to send mail */
